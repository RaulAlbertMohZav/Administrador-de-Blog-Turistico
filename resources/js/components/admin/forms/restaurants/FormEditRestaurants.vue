<template>
  <div>
    <v-form :action="urlForm" method="POST" enctype="multipart/form-data">
      ...
      <p class="headline">Edit Restaurant: "{{ title }}"</p>
      <v-container>
        <v-row>
          <v-col cols="12">
            <v-text-field
          ...
          <v-col cols="12">
            ...
            <small
              >If you do not select a File Video, the Video that is already
    ...
    <v-container>
      <hr />
      <div class="mt-8">
        <hours-item :items-hours="itemsHours" :id-restaurant="idRestaurant">
    ...
    <v-container>
      ...
      <div class="mt-8">
        <ambiences-item
          :items-ambiences="itemsAmbiences"
    ...
    <v-container>
      <hr />
      <div class="mt-8">
        <menus-item :items-menus="itemsMenus" :id-restaurant="idRestaurant">
          <template v-slot:csrf-token>
            <slot name="csrf-token"></slot>
          </template>
        </menus-item>
...
<script>
import hoursItem from "./items/Hours.vue";
import AmbiencesItem from "./items/Ambiences.vue";
import MenusItem from "./items/Menus.vue";
